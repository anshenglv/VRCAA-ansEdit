...
class RecentlyVisitedScreen : Screen {
    ...
    override fun Content() {
        ...
        val recentWorlds = CacheManager.recentWorldsState.collectAsState().value
        ...
        Scaffold(
            topBar = {
                TopAppBar(
                    ...
                    title = { Text(text = stringResource(R.string.home_recently_visited)) }
                )
            }
        ) { padding ->
            LazyVerticalGrid(
                ...
                items(recentWorlds) { world ->
                    GridItem(
                        name = world.name,
                        url = world.thumbnailUrl,
                        count = null,
                        onClick = { navigator.push(WorldScreen(world.id)) }
                    )
                }
            }
        }
